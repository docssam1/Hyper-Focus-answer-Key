// GFIELD 프리미어 하이퍼 포커스 — 원본 문제 이미지 매핑
// typeId → GitHub assets/problems/ 파일명

const PROBLEM_IMAGE_MAP = {
...
// 사용법
// const imgUrl = `./assets/problems/${encodeURIComponent(PROBLEM_IMAGE_MAP[typeId])}`;

if (typeof module !== 'undefined') module.exports = { PROBLEM_IMAGE_MAP };
